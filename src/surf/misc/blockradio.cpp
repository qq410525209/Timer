...
void CBlockRadio::OnPluginStart() {
	constexpr static const char* blockedCommands[] = {"playerchatwheel", "player_ping", "roger", "negative", "cheer", "holdpos", "thanks", "go", "fallback", "sticktog", "followme", "compliment", "enemyspot", "needbackup", "takepoint", "sectorclear", "inposition"};
