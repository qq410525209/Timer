...
#pragma warning(disable: 6239) // warning C6239: (<non-zero constant> && <expression>) always evaluates to the result of <expression>. Did you intend
							   // to use the bitwise-and operator?
#pragma warning(disable: 6285) // warning C6285: (<non-zero constant> || <non-zero constant>) is always a non-zero constant. Did you intend to use the
...
#pragma warning(disable: 6240) // warning C6240: (<expression> && <non-zero constant>) always evaluates to the result of <expression>. Did you intend
							   // to use the bitwise-and operator?
...
// #pragma warning(disable : 6262) // warning C6262: Function uses '16464' bytes of stack: exceeds /analyze:stacksize'16384'. Consider moving some
// data to heap
...
#pragma warning(disable: 6320) // warning C6320: Exception-filter expression is the constant EXCEPTION_EXECUTE_HANDLER. This might mask exceptions
							   // that were not intended to be handled
#pragma warning(disable: 6250) // warning C6250: Calling 'VirtualFree' without the MEM_RELEASE flag might free memory but not address descriptors
							   // (VADs). This causes address space leaks
